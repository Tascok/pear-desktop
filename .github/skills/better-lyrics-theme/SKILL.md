---
name: better-lyrics-theme
description: 'Better Lyrics Theme Creation Guide for AI Agents. Reference for creating custom themes, CSS variables, configuration knobs, dynamic properties, DOM structure, unison submitter card, floating dock, and styling patterns.'
argument-hint: 'custom theme styling options'
user-invocable: true
---
